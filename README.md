...
| Project | What it is | Proof | Stack | Live |
|---|---|---|---|---|
...
| **[OneAlert](https://github.com/mangod12/OneAlert)** | Open-source OT/ICS security OS | 30 stars · 330+ tests · 6 AI agents · MITRE ATT&CK mapping · Suricata/Zeek events | FastAPI · React 19 · PostgreSQL · Docker · Cloud Run | [open](https://cybersec-saas-498310931350.us-central1.run.app/app/) |
| **[TaskForge](https://github.com/mangod12/TaskForge)** | Multi-agent crisis logistics coordinator | Built for Google Cloud Gen AI Academy APAC 2026 · 4-agent pipeline · deterministic fallbacks | FastAPI · Gemini 2.5 Flash · MCP · PostgreSQL/pgvector · Cloud Run | repo |
| **[Redline AI](https://github.com/mangod12/redline-AI)** | Emergency dispatch IVR and dashboard | 409 tests · 33 E2E · Whisper + ONNX pipeline · Cloud SQL/Redis architecture | FastAPI · Twilio · Whisper · PostgreSQL · Redis | repo |
| **[SkyDash](https://github.com/mangod12/skydash)** | Open-source spatial intelligence dashboard | Geospatial maps · OSINT-style entities · link analysis · missions · simulated 10Hz telemetry | React · FastAPI · Leaflet · D3 · SQLite · WebSockets | repo |
...
- Looking for backend, systems, security, or AI engineering internships where I can ship to real users.
